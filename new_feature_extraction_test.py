...
#164+143+166+166+166+166+164=1135
dataset_features = numpy.zeros(shape=(1135, 360))
outputs = numpy.zeros(shape=(1135))
...
with open("Datasets/new_test_set_features.pkl", "wb") as f:
    pickle.dump(dataset_features, f)

with open("Datasets/new_test_set_labels.pkl", "wb") as f:
